...
const MenuMerchandise = ({setModalShow, setSubItem}) => { // the setSubItem is the setter which will get from the menu. two parameter the setmodalshow and set subitem 
  ...
  return (
    <div className='mb-10'> 
        <h4 className='text-2xl font-bold mb-10 border-b border-gray-200 py-5'>Merchandise</h4>
